      ...
      <div className="relative max-w-4xl mx-auto text-center">
        ...
        >
          <Link
            ...
            className="inline-flex items-center font-semibold gap-3 border border-alira rounded-md bg-[#D2AB67] text-white text-[16px] tracking-[0.25em] uppercase font-poppins px-10 py-4 hover:bg-white hover:text-alira transition-all duration-300"
          >
